...
# Import extended repository interfaces instead of duplicating
from app.modules.identity.application.contracts.extended_repositories import (
    IExtendedUserRepository as IUserRepository,
    IExtendedSessionRepository as ISessionRepository,
)


# Keep other repository interfaces that don't have domain equivalents
